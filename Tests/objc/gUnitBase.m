...
- (NSObject *) execParser:(NSString *)ruleName input:(NSString *)input scriptLine:(int)scriptLine
{
  ...
  ANTLRCommonTokenSource *lexer = (ANTLRCommonTokenSource *)[lexConstructor newInstance:lexArgs];
  ...
  if (adaptorClassName != nil) {
    ...
    Method *m = [parserClass getMethod:@"setTreeAdaptor" arg1:parArgTypes];
    Class *adaptorClass = [Class forName:adaptorClassName];
    [m invoke:parser arg1:[adaptorClass newInstance]];
  }
