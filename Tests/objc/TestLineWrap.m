...
- (void) testLineWrap {
  ...
  [a add:@"values" arg1:[NSArray arrayWithObjects:3, 9, 20, 2, 1, 4, 6, 32, 5, 6, 77, 888, 2, 1, 6, 32, 5, 6, 77, 4, 9, 20, 2, 1, 4, 63, 9, 20, 2, 1, 4, 6, 32, 5, 6, 77, 6, 32, 5, 6, 77, 3, 9, 20, 2, 1, 4, 6, 32, 5, 6, 77, 888, 1, 6, 32, 5, nil]];
  ...
  STWriter * stw = [[[AutoIndentWriter alloc] init:sw arg1:@"\n"] autorelease];
  [stw setLineWidth:40];
  [a write:stw];
...
- (void) testLineWrapAnchored {
  ...
  [self assertEquals:expecting arg1:[a render:40]];
}
...
- (void) testSubtemplatesAnchorToo {
  ...
  [x add:@"stuff" arg1:@"3"];
  ST * a = [group getInstanceOf:@"array"];
  [a add:@"values" arg1:[[[TestLineWrap_Anon1 alloc] init] autorelease]];
...
- (void) testFortranLineWrap {
  ...
  [a add:@"args" arg1:[NSArray arrayWithObjects:@"a", @"b", @"c", @"d", @"e", @"f", nil]];
  NSString * expecting = [@"       FUNCTION line( a,b,c,d,\n" stringByAppendingString:@"      ce,f )"];
  [self assertEquals:expecting arg1:[a render:30]];
}
...
- (void) testLineWrapWithDiffAnchor {
  ...
  STGroup * group = [[[STGroupFile alloc] init:[[tmpdir stringByAppendingString:@"/"] stringByAppendingString:@"t.stg"]] autorelease];
  ST * a = [group getInstanceOf:@"array"];
  [a add:@"values" arg1:[NSArray arrayWithObjects:3, 9, 20, 2, 1, 4, 6, 32, 5, 6, 77, 888, 2, 1, 6, 32, 5, 6, 77, 4, 9, 20, 2, 1, 4, 63, 9, 20, 2, 1, 4, 6, nil]];
...
- (void) testLineWrapEdgeCase {
  ...
  [a add:@"chars" arg1:[NSArray arrayWithObjects:@"a", @"b", @"c", @"d", @"e", nil]];
  NSString * expecting = [@"abc\n" stringByAppendingString:@"de"];
  [self assertEquals:expecting arg1:[a render:3]];
}
...
- (void) testLineWrapLastCharIsNewline {
  ...
  STGroup * group = [[[STGroupFile alloc] init:[[tmpdir stringByAppendingString:@"/"] stringByAppendingString:@"t.stg"]] autorelease];
  ST * a = [group getInstanceOf:@"duh"];
  [a add:@"chars" arg1:[NSArray arrayWithObjects:@"a", @"b", @"\n", @"d", @"e", nil]];
...
- (void) testLineWrapCharAfterWrapIsNewline {
  ...
  STGroup * group = [[[STGroupFile alloc] init:[[tmpdir stringByAppendingString:@"/"] stringByAppendingString:@"t.stg"]] autorelease];
  ST * a = [group getInstanceOf:@"duh"];
  [a add:@"chars" arg1:[NSArray arrayWithObjects:@"a", @"b", @"c", @"\n", @"d", @"e", nil]];
...
- (void) testLineWrapForList {
  ...
  STGroup * group = [[[STGroupFile alloc] init:[[tmpdir stringByAppendingString:@"/"] stringByAppendingString:@"t.stg"]] autorelease];
  ST * a = [group getInstanceOf:@"duh"];
  [a add:@"data" arg1:[NSArray arrayWithObjects:1, 2, 3, 4, 5, 6, 7, 8, 9, nil]];
  NSString * expecting = [[@"!123\n" stringByAppendingString:@"4567\n"] stringByAppendingString:@"89!"];
  [self assertEquals:expecting arg1:[a render:4]];
}
...
- (void) testLineWrapForAnonTemplate {
  ...
  [self assertEquals:expecting arg1:[a render:9]];
}
...
- (void) testLineWrapForAnonTemplateComplicatedWrap {
  ...
  [s add:@"data" arg1:[NSArray arrayWithObjects:1, 2, 3, 4, 5, 6, 7, 8, 9, nil]];
  [t add:@"s" arg1:s];
  ...
  [self assertEquals:expecting arg1:[t render:9]];
}
...
- (void) testIndentBeyondLineWidth {
  ...
  [self assertEquals:expecting arg1:[a render:2]];
}
...
- (void) testIndentedExpr {
  ...
  [self assertEquals:expecting arg1:[a render:6]];
}
...
- (void) testNestedIndentedExpr {
  ...
  [duh add:@"chars" arg1:[NSArray arrayWithObjects:@"a", @"b", @"c", @"d", @"e", nil]];
  [top add:@"d" arg1:duh];
  NSString * expecting = [[@"    ab\n" stringByAppendingString:@"    cd\n"] stringByAppendingString:@"    e!"];
  [self assertEquals:expecting arg1:[top render:6]];
}
...
- (void) testNestedWithIndentAndTrackStartOfExpr {
  ...
  [self assertEquals:expecting arg1:[top render:7]];
}
...
- (void) testSingleValueWrap {
  ...
  [self assertEquals:expecting arg1:[m render:2]];
}
...
- (void) testLineWrapInNestedExpr {
  ...
  [self assertEquals:expecting arg1:[top render:40]];
}
