...
- (void) testOneExpr {
  ...
  NSString * expected = [@"[[@0,0:0='<',<LDELIM>,1:0], [@1,1:4='name',<ID>,1:1], " stringByAppendingString:@"[@2,5:5='>',<RDELIM>,1:5]]"];
  [self checkTokens:template arg1:expected];
}

- (void) testOneExprSurrounded {
  NSString * template = @"hi <name> mom";
  NSString * expected = [[@"[[@0,0:2='hi ',<TEXT>,1:0], [@1,3:3='<',<LDELIM>,1:3], " stringByAppendingString:@"[@2,4:7='name',<ID>,1:4], [@3,8:8='>',<RDELIM>,1:8], "] stringByAppendingString:@"[@4,9:12=' mom',<TEXT>,1:9]]"];
  [self checkTokens:template arg1:expected];
}
...
- (void) testEscDelimHasCorrectStartChar {
  ...
  NSString * expected = [@"[[@0,0:0='<',<LDELIM>,1:0], [@1,1:1='a',<ID>,1:1], [@2,2:2='>',<RDELIM>,1:2], " stringByAppendingString:@"[@3,3:7='<dog',<TEXT>,1:3]]"];
  [self checkTokens:template arg1:expected];
}
...
- (void) testString {
  ...
  NSString * expected = [[[[@"[[@0,0:2='hi ',<TEXT>,1:0], [@1,3:3='<',<LDELIM>,1:3], " stringByAppendingString:@"[@2,4:6='foo',<ID>,1:4], [@3,7:7='(',<LPAREN>,1:7], "] stringByAppendingString:@"[@4,8:8='a',<ID>,1:8], [@5,9:9='=',<EQUALS>,1:9], "] stringByAppendingString:@"[@6,10:12='\">\"',<STRING>,1:10], [@7,13:13=')',<RPAREN>,1:13], "] stringByAppendingString:@"[@8,14:14='>',<RDELIM>,1:14]]"];
  [self checkTokens:template arg1:expected];
}

- (void) testEscInString {
  NSString * template = @"hi <foo(a=\">\\\"\")>";
  NSString * expected = [[[@"[[@0,0:2='hi ',<TEXT>,1:0], [@1,3:3='<',<LDELIM>,1:3], [@2,4:6='foo',<ID>,1:4], " stringByAppendingString:@"[@3,7:7='(',<LPAREN>,1:7], [@4,8:8='a',<ID>,1:8], [@5,9:9='=',<EQUALS>,1:9], "] stringByAppendingString:@"[@6,10:14='\">\"\"',<STRING>,1:10], [@7,15:15=')',<RPAREN>,1:15], "] stringByAppendingString:@"[@8,16:16='>',<RDELIM>,1:16]]"];
  [self checkTokens:template arg1:expected];
}
...
- (void) testIF {
  ...
  NSString * expected = [[[[@"[[@0,0:0='<',<LDELIM>,1:0], [@1,1:2='if',<IF>,1:1], [@2,3:3='(',<LPAREN>,1:3], " stringByAppendingString:@"[@3,4:4='!',<BANG>,1:4], [@4,5:8='name',<ID>,1:5], [@5,9:9=')',<RPAREN>,1:9], "] stringByAppendingString:@"[@6,10:10='>',<RDELIM>,1:10], [@7,11:15='works',<TEXT>,1:11], "] stringByAppendingString:@"[@8,16:16='<',<LDELIM>,1:16], [@9,17:21='endif',<ENDIF>,1:17], "] stringByAppendingString:@"[@10,22:22='>',<RDELIM>,1:22]]"];
  [self checkTokens:template arg1:expected];
}
...
- (void) testIFELSE {
  ...
  NSString * expected = [[[[[@"[[@0,0:0='<',<LDELIM>,1:0], [@1,1:2='if',<IF>,1:1], [@2,3:3='(',<LPAREN>,1:3], " stringByAppendingString:@"[@3,4:7='name',<ID>,1:4], [@4,8:8=')',<RPAREN>,1:8], [@5,9:9='>',<RDELIM>,1:9], "] stringByAppendingString:@"[@6,10:14='works',<TEXT>,1:10], [@7,15:15='<',<LDELIM>,1:15], "] stringByAppendingString:@"[@8,16:19='else',<ELSE>,1:16], [@9,20:20='>',<RDELIM>,1:20], "] stringByAppendingString:@"[@10,21:24='fail',<TEXT>,1:21], [@11,25:25='<',<LDELIM>,1:25], "] stringByAppendingString:@"[@12,26:30='endif',<ENDIF>,1:26], [@13,31:31='>',<RDELIM>,1:31]]"];
  [self checkTokens:template arg1:expected];
}

- (void) testELSEIF {
  NSString * template = @"<if(name)>fail<elseif(id)>works<else>fail<endif>";
  NSString * expected = [[[[[[[[[@"[[@0,0:0='<',<LDELIM>,1:0], [@1,1:2='if',<IF>,1:1], [@2,3:3='(',<LPAREN>,1:3], " stringByAppendingString:@"[@3,4:7='name',<ID>,1:4], [@4,8:8=')',<RPAREN>,1:8], [@5,9:9='>',<RDELIM>,1:9], "] stringByAppendingString:@"[@6,10:13='fail',<TEXT>,1:10], [@7,14:14='<',<LDELIM>,1:14], "] stringByAppendingString:@"[@8,15:20='elseif',<ELSEIF>,1:15], [@9,21:21='(',<LPAREN>,1:21], "] stringByAppendingString:@"[@10,22:23='id',<ID>,1:22], [@11,24:24=')',<RPAREN>,1:24], "] stringByAppendingString:@"[@12,25:25='>',<RDELIM>,1:25], [@13,26:30='works',<TEXT>,1:26], "] stringByAppendingString:@"[@14,31:31='<',<LDELIM>,1:31], [@15,32:35='else',<ELSE>,1:32], "] stringByAppendingString:@"[@16,36:36='>',<RDELIM>,1:36], [@17,37:40='fail',<TEXT>,1:37], "] stringByAppendingString:@"[@18,41:41='<',<LDELIM>,1:41], [@19,42:46='endif',<ENDIF>,1:42], "] stringByAppendingString:@"[@20,47:47='>',<RDELIM>,1:47]]"];
  [self checkTokens:template arg1:expected];
}

- (void) testEmbeddedRegion {
  NSString * template = @"<@r>foo<@end>";
  NSString * expected = [[@"[[@0,0:0='<',<LDELIM>,1:0], [@1,1:1='@',<AT>,1:1], [@2,2:2='r',<ID>,1:2], " stringByAppendingString:@"[@3,3:3='>',<RDELIM>,1:3], [@4,4:6='foo',<TEXT>,1:4], [@5,7:7='<',<LDELIM>,1:7], "] stringByAppendingString:@"[@6,8:11='@end',<END>,1:8], [@7,12:12='>',<RDELIM>,1:12]]"];
  [self checkTokens:template arg1:expected];
}

- (void) testRegion {
  NSString * template = @"<@r()>";
  NSString * expected = [@"[[@0,0:0='<',<LDELIM>,1:0], [@1,1:1='@',<AT>,1:1], [@2,2:2='r',<ID>,1:2], " stringByAppendingString:@"[@3,3:3='(',<LPAREN>,1:3], [@4,4:4=')',<RPAREN>,1:4], [@5,5:5='>',<RDELIM>,1:5]]"];
  [self checkTokens:template arg1:expected];
}
